...
def build_diden_humanoid_hand_config() -> "dict[str, ModalityConfig]":
    ...
    return {
        ...
        "action": ModalityConfig(
            ...
            modality_keys=["right_arm_joint_pos", "right_grasp_ratio"],
            action_configs=[
...
def register_diden_humanoid_right_hand_fixed_finger() -> None:
...
register_diden_humanoid_right_hand_fixed_finger()
