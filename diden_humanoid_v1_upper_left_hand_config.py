...
def build_diden_humanoid_hand_config() -> "dict[str, ModalityConfig]":
    ...
    return {
        ...
        "state": ModalityConfig(
            delta_indices=[0],
            # modality_keys=["left_arm_joint_pos", "left_arm_joint_vel", "left_ee_pos", "finger_left", "fingertip_left", "left_grasp_ratio"],
        ...
        "action": ModalityConfig(
            ...
            modality_keys=["left_arm_joint_pos", "finger_left"],
            action_configs=[
...
def register_diden_humanoid_left_hand_action() -> None:
...
register_diden_humanoid_left_hand_action()
